...
*Decision:* `--frame-max` is `clamp(560px, calc((--frame-budget - 2px) * 520 / (400 * --leading)), 640px)`. `.pages` and `.bar__inner` both keep their plain `max-width: var(--frame-max)`.
