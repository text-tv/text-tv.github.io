 ...
 *
 * Delete this file, and its two lines in App, once the shell is trusted on
 * iOS. It exists because the interesting moment is a reload on a device with
 * no console attached, and a screenshot is the only way the numbers get out.
 */
export const diagnosticsWanted = () =>
...
export function Diagnostics() {
  ...
  // Centred, not pinned to an edge: the shell it is reporting on may itself
  // be off the top of the screen, and so would a readout stuck to it.
  return (
